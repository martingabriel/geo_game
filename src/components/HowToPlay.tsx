  ...
  return (
    <details className="group rounded-xl border border-gray-200 bg-white px-5 py-3 text-sm text-gray-600">
      ...
      <div className="mt-3 space-y-3">
        ...
        <div>
          <p className="font-medium text-gray-700 mb-1">Bodování</p>
          <table className="w-full text-xs border-collapse">
            <tbody>
              <tr className="border-b border-gray-100">
                ...
                <td className="py-1 text-gray-500">do 50 m</td>
                <td className="py-1 text-right font-medium text-gray-700">1 000 bodů</td>
              </tr>
              <tr className="border-b border-gray-100">
                <td className="py-1 pr-3">
                ...
                <td className="py-1 text-gray-500">do 200 m</td>
                <td className="py-1 text-right font-medium text-gray-700">500 bodů</td>
              </tr>
              <tr>
                <td className="py-1 pr-3">
                ...
                <td className="py-1 text-gray-500">více než 200 m</td>
                <td className="py-1 text-right font-medium text-gray-700">0 bodů</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div>
          <p className="font-medium text-gray-700 mb-1">Herní módy</p>
